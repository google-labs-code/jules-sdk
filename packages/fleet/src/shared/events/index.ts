...
// ── Fleet Event Re-exports ──────────────────────────────────────────
// This barrel aggregates per-domain event types into a single union.
// Adding a new domain? Create shared/events/<domain>.ts and add it here.
